...
{
    /// <inheritdoc />
    public partial class AddPaymentSetupStateTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Add PaymentSetupStates table if not existing
            ...
            // Add unique composite index for idempotent attempts if not present
